...
HRESULT CMainApp::Ready_MainApp(void)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Font(m_pGraphicDev, L"Font_Cookie", L"CookieRun Bold", 30, 30, FW_HEAVY), E_FAIL);
...
void CMainApp::Render_MainApp(void)
{
	...
	//Engine::Render_Font(L"Font_Cookie", m_szFPS, &_vec2(1700.f, 10.f), D3DXCOLOR(1.f, 1.f,0.f, 1.f));
