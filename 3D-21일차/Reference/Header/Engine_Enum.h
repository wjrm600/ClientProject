...
namespace Engine
{
	...
	enum PLAYERMOVESTATE { PMS_CLIMBUP, PMS_CLIMBDOWN,PMS_FRONTJUMP, PMS_ATTACK, PMS_DAMAGE,PMS_END};
	enum PLAYERHEIGHTCOLLISIONSTATE {PHCS_ON, PHCS_SIDE, PHCS_END};
	enum BOSSMOVESTATE {BMS_INTRO, BMS_TARGETMOVE, BMS_ATTACK, BMS_FIRE, BMS_DEAD,BMS_END};
	enum BOSSPATTERN {BP_ONE, BP_TWO, BP_THREE, BP_END};
	enum COLLIDERHEIGHT{ CH_LOW, CH_HIGH, CH_FRONTJUMP, CH_NEXTSTAGE,CH_END};
}
